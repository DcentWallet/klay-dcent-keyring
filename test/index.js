...
describe('DcentKeyring', function () {
    ...
    describe('signTypedData', function () {
        ...
        it('getSignedData : should call DcentWebConnector.getSignedData', function (done) {

            chai.spy.on(DcentWebConnector, 'getSignedData')
            keyring.signTypedData(fakeAddress, msgParams).catch(e => {
              //     // we expect this to be rejected because
              //     // we are trying to open a popup from node
                   expect(DcentWebConnector.getSignedData).to.have.been.called()
                   done()
              })
        })
    })
